(function() {
    ...
    function modSearch() {
        ...
        /* @ngInject */
        function controller($scope, $state, $stateParams, $timeout, $rootScope, $q, $http, $filter, gettext, gettextCatalog, Config, Lang, AuthorityService) {
            ...
            function activate() {
                ...
                AuthorityService.onSubject($scope, function (subject) {
                    vm.searchHistory = AuthorityService.searchHistory;
                });
