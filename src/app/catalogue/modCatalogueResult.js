(function() {
    ...
    angular
        ...
        .directive('modCatalogueResult', modCatalogueResult);


    /* @ngInject */
    function modCatalogueResult(Lang, Catalogue, Config, AuthorityService, $state, ngToast, gettext, gettextCatalog, $analytics, $stateParams) {
